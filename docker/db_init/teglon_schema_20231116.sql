...
) ENGINE=InnoDB AUTO_INCREMENT=50134924 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1614265 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `HealpixPixel_Galaxy_Weight` (
  ...
  KEY `FK_Healpix_Galaxy_Weight_HealpixMap_idx` (`HealpixMap_id`),
  CONSTRAINT `FK_Healpix_Galaxy_Weight_HealpixMap` FOREIGN KEY (`HealpixMap_id`) REFERENCES `HealpixMap` (`id`),
...
CREATE TABLE `ObservedTile` (
  ...
  `HealpixMap_id` int NOT NULL,
  `PositionAngle` double DEFAULT '0',
  `x0` double DEFAULT NULL,
  `x0_err` double DEFAULT NULL,
  `a` double DEFAULT NULL,
  `a_err` double DEFAULT NULL,
  `n` double DEFAULT '1',
  `n_err` double DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=17447 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ObservedTile_HealpixPixel` (
  ...
  KEY `FK_ObservedTile_HealpixPixel_HealpixMap_id_idx` (`HealpixMap_id`),
  CONSTRAINT `FK_ObservedTile_HealpixPixel_HealpixMap_id` FOREIGN KEY (`HealpixMap_id`) REFERENCES `HealpixMap` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1758582 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=396826 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `StaticTile_HealpixPixel` (
  ...
  KEY `FK_StaticTile_HealpixPixel_HealpixMap_id_idx` (`HealpixMap_id`),
  CONSTRAINT `FK_StaticTile_HealpixPixel_HealpixMap_id` FOREIGN KEY (`HealpixMap_id`) REFERENCES `HealpixMap` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1652703 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-16 20:53:06
