...
glade_catalog_in = "./GLADE_2.4.txt"
glade_catalog_mid = "./GLADE_2.4.mid.txt"
glade_catalog_out = "./GLADE_2.4.out.txt"
# glade_catalog_in = "./GLADE_2.4.small.txt"
# glade_catalog_mid = "./GLADE_2.4.small.mid.txt"
# glade_catalog_out = "./GLADE_2.4.small.out.txt"
# reset output
glade_H0 = 70.0
glade_Om0 = 0.27
z_err = 300./3e5
